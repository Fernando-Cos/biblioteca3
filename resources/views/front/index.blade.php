...
<h4><small class="pull-right">200</small></h4>
<div class="row-fluid">
                    ...
                    <li class="span3">
                        <div class="thumbnail">
                            ...
                            <a href="product_details.html">
                                <img src="{{ asset('images/front_images/carousel/work.png') }}" alt=""></a>
                            <div class="caption">
            ...
            <div class="item">
                <ul class="thumbnails">
                    <li class="span3">
                        <div class="thumbnail">
                            <i class="tag"></i>
                            <a href="product_details.html"><img src="{{ asset('images/front_images/carousel/work.png') }}" alt=""></a>
                            <div class="caption">
                                {{-- <h5>Product name</h5> --}}
                                <h4><a class="btn" href="product_details.html"></a> <span class="pull-right">Rs.1000</span></h4>
                            </div>
                        </div>
                    </li>
                </ul>
