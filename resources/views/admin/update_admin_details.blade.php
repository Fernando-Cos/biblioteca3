...
<div class="container-fluid">
  ...
  @endif
    ...
    @endif
        ...
        <!-- form start -->
        <form>
          <div role="form" class="card-body" method="POST" action="{{ url('/admin/update-admin-details') }}" name="updateAdminDetails"
          id="updateAdminDetails" enctype="multipart/fom-data" >@csrf
