		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="item active">
					<div class="container">
						<a href="#"><img style="width:60%" src="{{ asset('images/front_images/carousel/work.png') }}" alt="special offers"/></a>
				...
				<div class="item">
					<div class="container">
						<a href="register.html"><img style="width:60%" src="{{ asset('images/front_images/carousel/work.png') }}" alt=""/></a>
						<div class="carousel-caption">
