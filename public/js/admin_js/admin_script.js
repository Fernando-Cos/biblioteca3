    ...
    $(".updateProductStatus").click(function() {
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(resp['status']==0){
                    $("#product-"+product_id).html("<a class='updateProductStatus' href='javascript:void(0)'>Inativo</a>");
                } else if(resp['status']==1){
                    $("#product-"+product_id).html("<a class='updateProductStatus' href='javascript:void(0)'>Ativo</a>");
                }
            },error:function(){
                alert('ERROR');
            }
