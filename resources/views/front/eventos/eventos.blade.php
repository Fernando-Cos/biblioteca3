        ...
        <table class="tabelaConsultas">
            <thead>
                <tr>
                    ...
                    <th id="thCabecalho1" style="" class="ordenacao1" onclick="">Eventos
...
<article class="vdb-card paper horizontal rounded" style="margin-right: 5%;">
 ...
 <div class="content">
        ...
        <h4 class="hidden-xs hidden-sm">Essa música retrata o queconquistas e responsável por suas falhas.</a></h4>
    ...
    <article class="vdb-card paper horizontal rounded" style="margin-right: 5%;">
     ...
     <div class="content">
        ...
        <article class="vdb-card paper horizontal rounded" style="margin-right: 5%;margin-left: 12%;">
            <div class="tag">
                <span class="hidden-xs hidden-sm">Em Test</span>
            </div>
            <a href="">
